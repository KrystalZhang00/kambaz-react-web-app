...
export default function ModulesControls(
  { moduleName, setModuleName, addModule, isFaculty }: {  // CHANGE 1: Add isFaculty to props
    moduleName: string; 
  ...
  return (
    <div id="wd-modules-controls" className="text-nowrap mb-4">
      {/* CHANGE 2: Only show Add Module button for faculty */}
      {isFaculty && (
      ...
      {/* The modal can stay available but won't be accessed without the button */}
      <ModuleEditor 
        show={show} 
